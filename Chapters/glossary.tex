...
\newglossaryentry{selfconsistency}{
	name={self consistency method},
	description={The electron wavefunctions go through a variational process in order to  reach convergence for an energetic minimum.}
}