...
\begin{figure}[h!]
    ...
    \caption{Wavefunction at the beginning and end of the self-consistent iterative process.}\label{fig:WFcomp}
\end{figure}
...
\begin{table}[h!]
    \centering
    \caption{Total number of levels calculated. For all but the first row, the orbital represented is the one where an electron was excited to.}
